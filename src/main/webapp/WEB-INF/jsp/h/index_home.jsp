									...
									<div class="left_shop">
										...
										<div class="Shops_content">
											...
											<ul class="clearfix">
												...
												<li><label class="name">开通时间：</label>2018-12-21</li>
											</ul>
										</div>
										<div class="right_shop">
											<p> 店铺动态评分：</p>
											<ul>
												<li><label class="name">相符描述</label><span class="score">9.5分</span></li>
												<li><label class="name">服务态度</label><span class="score">9.0分</span></li>
												<li><label class="name">发货速度</label><span class="score">9.6分</span></li>
											</ul>
										</div>
									</div>
								...
								<table class="table table_striped  table-hover">
									...
									<tbody>
										...
										<tr>
											...
											<td>192.168.0.156</td>
											<td>admin1 <span class="tab_prompt bg-gray">离线</span></td>
										</tr>
										<tr>
											<td>2018-09-12 12:21</td>
											<td>192.168.0.156</td>
											<td>admin2 <span class="tab_prompt bg-gray">离线</span></td>
										</tr>
									</tbody>
								</table>
							</div>
