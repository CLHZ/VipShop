...
<html>
	...
	<body class="login-layout Reg_log_style" id="loginstyle">
					...
					<div id="login-box" class="login-box widget-box no-border visible">
						...
						<div class="skin-section">
							...
							<div class="Bombbox">
								<ul class="skin-list">
									<li>
										<a class="colorpick-btn" href="javascript:void(0)" data-val="red" id="default" style="background-color:#FF6868"></a>
									</li>
									<li>
									...
									<li>
										<a class="colorpick-btn" href="javascript:void(0)" data-val="black" style="background-color:#222A2D;"></a>
									</li>
									<li>
		...
		<div class="loginbm">版权所有 zenglei</div>
	</body>
</html>
